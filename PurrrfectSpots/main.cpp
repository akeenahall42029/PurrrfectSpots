...
//public void linkRes(int napSpotID, int userId, std::string& userName, int time, const std::string& status){
...
// configuration set below.
    MyButton button1("Button 1 -- Log in");
    MyButton button2("Button 2 -- Sign Up");
...
// This is performed with pack_start, there are other similar methods.
    ...
    hbox1.pack_start(button2,Gtk::PACK_EXPAND_WIDGET, 5);
